    ...
    <div className="pt-6 font-open_sans flex flex-col gap-6">
        ...
        <section className="space-y-6 mx-auto w-full max-w-4xl">
            ...
            <div className='flex flex-col gap-4'>
                ...
                <p>It's not like what we think of those time-traveling movies. Still, the results are the same: we are in a time where many years passed to others!</p>

                <p>Let me introduce you the time dilation formula:</p> 
                <img src={time_dilation_formula} className='h-[300px] w-[500px]'/>
                <p>
                    The equation tells that dilated time is directly proportional to velocity.
        ...
        <section className="space-y-6 mt-12 mx-auto max-w-4xl">
            ...
            <p>
                You don't need to understand how time dilation formula was derived to understand the correlation between time and speed.
            ...
            <div className='flex flex-col items-center gap-6'>
                <div className='flex gap-4 max-w-4xl'>
                    ...
                    <p>
                        Suppose there are two astronauts A and B. Astronaut A is on a space shuttle moving at a constant speed v, while B is standing on the Earth.
                    </p>
                </div>
                <div className='flex gap-4 max-w-4xl'>
                    <img src='/images/twin_paradox2.png' alt='twin_paradox2.png' className='h-[450px]'/>
                    <p>
                        On the starting point of motion, astronaut A shots a laser beam vertically. This beam hits the top ceiling of the shttle and and reflect back to its ground.
                    </p>
                </div>
                <div className='flex gap-4 max-w-4xl'>
                    <img src='/images/twin_paradox3.png' alt='twin_paradox3.png' className='h-[450px]'/>
                    <p>
                        But in B's perspective, the total distance of the laser light travelled is longer.
                    </p>
                </div>
                <div className='flex gap-4 max-w-4xl'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <p>
                            In A's perspective, the total distance light travelled is only 2d. 
                            (* d: vertical distance of light beam)
                        </p>
                        <p>
                            Since time is universal and the space shuttle is moving uniformly at v, A's time must be dilated to cover the longer distance while maintaining its speed.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <p>
                In daily lives, we experience time dilation whenever we drive a car or take a bus.
                But its effect is so tiny and negligible that it hardly affects our lives and we never notice it.
            </p>
            <p>
                To see a significant effect, we must reach a speed close to the light's speed.
            </p>
        </section>
        ...
        <section className="space-y-6 mt-12 mx-auto max-w-4xl">
            ...
            <div className='flex flex-col gap-4'>
                ...
                <p>
                    Kelly travelled total 520 days in space at around 28160km/h.
                ...
                <MathJaxContext version={3} config={math_jx_config}>
                    ...
                    <MathJax>{"time difference due to dilation: $t _\\text{dilated}-t_\\text{earth}= 0.02 s$"}</MathJax>
                </MathJaxContext>
                <p>Scotty Kelly aged 0.02 seconds slowerly than his twin brother Mark during the 520 days in orbit!</p>
            </div>
        </section>
    </div>
  )
